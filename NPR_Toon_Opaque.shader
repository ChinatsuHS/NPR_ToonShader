    ...
    SubShader
    {
        ...
        Pass // Main Rendering Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed4 packedTex = tex2D(_PackedTexture, i.uv);
                float occlusion = GetChannel(packedTex, _OcclusionChannel);
                float roughness = GetChannel(packedTex, _RoughnessChannel);
                float metalness = GetChannel(packedTex, _MetalnessChannel);
